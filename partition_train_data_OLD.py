...
if __name__ == "__main__":
    ...
    all_train_data[CORRECT_AE_TABLE_COL] = generate_correct_autoenrollment_table(all_train_data)
    all_train_data[CORRECT_AE_SNIPPET_COL] = generate_correct_autoenrollment_snippet_col(all_train_data)

    all_train_data[CORRECT_VESTING_TABLE_COL] = generate_correct_vesting_table(all_train_data)
    all_train_data[CORRECT_VESTING_SNIPPET_COL] = generate_correct_vesting_snippet_col(all_train_data)
